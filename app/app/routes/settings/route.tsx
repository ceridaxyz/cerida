...
export const meta = () => [{ title: 'Settings - Cerida' }]
        ...
        <div className="mx-auto max-w-[1440px] px-5 py-5">
          <div className="mb-5 flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-[12px] text-text-quaternary">Account, wallet, keeper, and local development controls.</p>
            </div>
          ...
          <div className="grid grid-cols-[260px_minmax(0,1fr)] gap-5 max-[900px]:grid-cols-1">
            <aside className="border border-border-subtle bg-surface-primary">
              ...
              <nav className="p-2">
                {sections.map((item) => (
                  <button
                    ...
                    className={cx(
                      'mb-1 flex w-full items-center gap-3 rounded-[6px] px-3 py-2.5 text-left text-[12px] font-semibold transition-colors',
                      section === item.id
            ...
            <section className="min-w-0 border border-border-subtle bg-surface-primary">
              ...
              {section === 'profile' && (
                <div className="grid gap-px bg-border-subtle">
                  <div className="grid grid-cols-2 gap-4 bg-surface-primary p-5 max-[780px]:grid-cols-1">
                    <Field label="Display name">
                      <input
                        value={displayName}
                        onChange={(e) => setDisplayName(e.target.value)}
                        className="h-10 w-full border border-border-subtle bg-page px-3 text-text-primary"
                      />
                    </Field>
                  ...
                  <div className="bg-surface-primary">
                    {wallets.map((wallet) => (
                      <div key={wallet.label} className="grid grid-cols-[180px_minmax(0,1fr)_120px_80px] items-center gap-4 border-b border-border-subtle px-5 py-4 last:border-b-0 max-[780px]:grid-cols-1">
                        ...
                        <button
                          ...
                          className="flex min-w-0 items-center gap-2 text-left text-[12px] text-text-quaternary hover:text-text-secondary"
                        >
              ...
              {section === 'preferences' && (
                <div>
                  <div className="grid grid-cols-3 gap-4 border-b border-border-subtle p-5 max-[920px]:grid-cols-1">
              ...
              {section === 'api' && (
                <div>
                  <div className="grid grid-cols-2 gap-4 border-b border-border-subtle p-5 max-[900px]:grid-cols-1">
                ...
                <div className="p-5">
                  <div className="grid grid-cols-3 gap-3 max-[980px]:grid-cols-1">
                    {['Download account CSV', 'Export fills JSON', 'Reset local layout'].map((label) => (
                      <button key={label} className="h-10 border border-border-subtle bg-page px-3 text-[11px] font-semibold uppercase tracking-widest text-text-secondary hover:text-text-primary">
                        {label}
                      </button>
                    ))}
                  </div>
